...
def populate_table(event_array)
  @event = @@DB[:EventTable]
    ...
    :Borough => value["borough"],:Neighborhood => value["neighborhood"],:StreetAddress => value["street_address"],:CrossStreet => value["cross_street"],:City => value["city"],
    :State => value["state"],:PostalCode => value["postal_code"],:Telephone => value["telephone"],:VenueWebsite => value["venue_website"],:CriticName => value["critic_name"],:Category => value["category"],
